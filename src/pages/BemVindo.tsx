    ...
    >
      ...
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle1" sx={{ fontWeight: 500, color: theme.palette.text.primary, mb: 0.5 }}>
          Olá, <span style={{ color: theme.palette.mode === 'dark' ? '#82B1FF' : '#1976d2' }}>{nome}</span>!
        </Typography>
        ...
        <Typography variant="body2" sx={{ color: theme.palette.text.secondary, mb: 1 }}>
          Este é o Sistema de Frotas da UNIR, sua central oficial para controle de veículos, corridas e todas as movimentações da frota.
        </Typography>
